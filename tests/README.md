...
- `test_feature_store.py`, `test_research_backtest_runner.py`, and `test_research_boundaries.py` - offline feature store, session-aware research backtest, and safety-boundary tests.
