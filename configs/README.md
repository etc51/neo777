...
- `research.yaml` - offline research session profile and short-recording backtest settings.
...
- YAML is the source of truth for runtime, strategy, risk, research, and instruments.
